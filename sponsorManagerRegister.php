...
<html>
<head>
	<title>Safe Driver - Sponsor Company Manager Registration</title>
	<style type="text/css">
...
<body>
<h2 class = "dark">Register as a Company Sponsor Manager</h2>
<form method="post" class>
  ...
  <div>
	<button type="submit" name="SM_register_btn" class="input"> Register </button>
  </div>
</form>
